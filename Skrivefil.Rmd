...
Etter fem uker med trening var ikke forskjellen like stor som ved 12 uker. Dette kan stemme med @radaelli2014, selv om han ikke så forskjell mellom ett og tre sett. I den studein så de på effekten av seks uker hos utrente hvor fordatterene konkluderer med at ett sett gir like god effekt som tre sett hos uttrente i startfasen av styrketrening [@radaelli2014]. Selv om stuien vår viser at tre sett er fordelaktig også i en starfase, kan likevel se en relativt stor økning etter fem uker. I vår studie hadde vi også forsøkspersoner som var vant med trening, noe som også vil gi dem et annaet utgangspunkt enn utrente. Til tross for det såg @hass2000 i sin studie at ett sett var like bra som tre hos trente personer, også på lang sikt. Det som likvell skille denne studien fra vår i tillegg til at vi ikke hadde to grupper, er at de såg på styrketester i både overkropp og underkropp [@hass2000]. Når man ser på resultatet i studien er det signifikant forskjell i favør tre sett i leggfleksjon og de er generelt ikke overbevisende resulatat for ett sett på underkroppsøvelser [@hass2000]. Det kan dermed virke som at tre sett er å foretrekke på underkroppen mens ett sett kan være nok på overkroppen, noe som også stemmer godt overens med andre studeier [@rønnestad2007; @paulsen2003].
