...
Benet som trente tre sett økte signifikant mer enn benet som trente
ett sett, med henholdsvis økning på 3.37% (±4.59%) og 2.05% (±3.62) (p \<
0.05) (figur 1). Det var ingen forskjell mellom benene ved pre.
...
Begge gruppene økte i styrke fra pre til uke 5 og uke 5 til
post (figur2) (p \< 0.05). Den største økningen kom for begge
treningsmetodene mellom pre og uke fem (begge p \< 0.01) (tabell 1). Fra uke
5 og post var det en økning på 10% for benet som trente 3 sett og 6.8% for
benet som trente 1 sett (begge p \< 0.01). Benet som trente tre sett økte mer
en benet som trente ett sett ved både 5 uker og ved post-test (tabell 1).
...
Etter fem uker med trening var ikke forskjellen like stor som ved 12 uker. Dette kan stemme med @radaelli2014, selv om han ikke så forskjell mellom ett og tre sett. I den studeien så de på effekten av seks uker hos utrente hvor forfatterene konkluderte med at ett sett gir like god effekt som tre sett hos uttrente i startfasen av styrketrening [@radaelli2014]. Selv om stuien vår viser at tre sett er fordelaktig også i en starfase, kan man likevel se en overlegen effekt av tre sett fra uke fem til 12. Dette tyder på at volum blir viktigere og viktigere jo lengre treningsperioden er. I vår studie hadde vi også forsøkspersoner som til en viss grad var vant med trening, noe som vil gi dem et annaet utgangspunkt enn helt utrente som @radaelli2014 såg på. Imotsetning til dette såg @hass2000 i sin studie at ett sett var like bra som tre sett også hos trente personer, på både kort og lang sikt. Det som likevel skiller denne studien fra vår i tillegg til at vi ikke hadde to grupper, er at de såg på styrketester i både overkropp og underkropp [@hass2000]. Når man ser på resultatet i studien er det signifikant forskjell i favør tre sett i leggfleksjon og generelt ikke overbevisende resulatat for ett sett på underkroppsøvelser [@hass2000]. Det kan dermed virke som at tre sett er å foretrekke på underkroppen mens ett sett kan være nok på overkroppen. Denne konklusjonen stemmer godt overens med andre studeier [@rønnestad2007; @paulsen2003]. Likevel kunne det vært interessant om man også ser denne effeken om man har samme studiedesign som i denne studien, hvor man hadde trent forskjellig på venstre og høye arm.

I forhold til økning i muskelmasse var det en liten, men gyldig økning i vår studeie. Lignende funn så @schoenfeld2019, som konkluderer med at det er en dose-respons-effekt på økning i muskelmasse. Det samme klarete ikke @galvão2005 å finne når han så på ett vs. tre sett hos eldre mennesker. Det kan potensielt forklares med at eldre trenger mer protein for å oppnå økning i muskelmasse samtidig som at de ikke er like flinke til få i seg proteiner som unge [@kraemer1999; @moore2015]. Vår studie skiller seg generelt fra andre da muskelmasseøkningen teretisk er lik når begge intervensjonene skjer på samme person samtidig.

### Konklusjon

Både tre sett og ett sett gir god effekt på beinstyrken, men tre sett gir bedre styrkeeffekt en ett sett, spesielt etter fem uker. Tre sett er også å foretrekke for å oppnå økning muskelmasse.
